...
const DoctorListDetails = ({ doctor }) => {
    ...
    <div className='p-3 lg:p-5'>
      ...
      <div className='mt-2 lg:mt-4 flex items-center justify-between'>
        ...
        <div className='flex items-center gap-[6px]'>
          ...
          <span className='text-[14px] leading-6 lg:text-[16px] leading-7 font-semibold text-headingColor'>
            ({totalRating})
          </span>
        </div> 
      </div>
      <div className='mt-[18px] lg:mt-5 flex items-center justify-between'>
        <div>
          <h3 className='text-[16px] leading-7 lg:text-[18px] leading-[30px] font-semibold'>+{totalPatients}</h3>
          <p className='text-[14px] leading-6 font-[400] text-textColor'>{hospital}</p>
        </div>
        <Link to={`/doctors/${id}`} className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] flex items-center justify-center  hover:bg-primaryColor hover:border-none'>
